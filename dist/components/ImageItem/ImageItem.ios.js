...
const ImageItem = ({ imageSrc, onZoom, onRequestClose, onLongPress, delayLongPress, swipeToCloseEnabled = true, doubleTapToZoomEnabled = true, layout, handleImageClick }) => {
    ...
    return (<View>
      <ScrollView ref={scrollViewRef} style={layoutStyle} pinchGestureEnabled nestedScrollEnabled={true} showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} maximumZoomScale={maxScale} contentContainerStyle={{
        ...
        <TouchableWithoutFeedback onPress={(e) => { handleImageClick(); if (doubleTapToZoomEnabled)
        handleDoubleTap(e); }} onLongPress={onLongPressHandler} delayLongPress={delayLongPress}>
