...
const usePanResponder = ({ initialScale, initialTranslate, onZoom, doubleTapToZoomEnabled, onLongPress, delayLongPress, layout }) => {
    ...
    let MIN_DIMENSION = Math.min(layout.width, layout.height);
